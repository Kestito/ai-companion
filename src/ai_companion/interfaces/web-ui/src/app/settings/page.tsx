  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-6">
      <div className="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-8 max-w-2xl w-full text-center">
        ...
        <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-6">System Configuration</h2>
        ...
        <p className="text-gray-600 dark:text-gray-300">
          The settings page will allow administrators to configure system preferences,
          manage user permissions, set up integrations, and customize the platform to meet specific requirements.
        </p>
      </div>
    </div>
  );
